<?php
//$Id: calendrierbas2.php,v 1.1 2008-07-17 11:31:33 jbastide Exp $ 
...
//
    ...
    echo "\t</head>\n";
    echo "<body bgcolor='#FDD548'><form name='f1'>";
...
?>
    ...
    parent.opener.document.f2.<?php echo $_GET['origine']?>.value = affMy + "/" + affMois + "/" +  document.f1.annee.value;
    parent.close();
    }
    </script>
</BODY>
