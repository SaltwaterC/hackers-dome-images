<?php   
//$Id: combo2.php,v 1.2 2008-09-22 09:08:01 jbastide Exp $
/*
...
// 1 seule ligne
var z = "<?php echo $champOrigine;?>";

opener.document.f2.<?php echo $champCorrel;?>.value = "<?php echo $x;?>";
opener.document.f2.<?php echo $champOrigine;?>.value = "<?php echo $y;?>";
...
function recup()
    {
    var s = document.f3.<?php echo $champOrigine;?>.value;
    var x = s.split( "£" );
    opener.document.f2.<?php echo $champOrigine;?>.value = x[1];
    opener.document.f2.<?php echo $champCorrel;?>.value =x[0];
    this.close();
    }
</script>
