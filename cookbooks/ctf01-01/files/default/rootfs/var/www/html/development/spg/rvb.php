<?php
/*
$Id: rvb.php,v 1.2 2008-07-17 09:44:15 jbastide Exp $
rvb
gestion rvb
origine :
auteur: BERNARD MARTIN-RABAUD">
        WebExpert
Cette fonction a été transformée et transformée en php pour
être utilisée avec openMairie 20/04/2006
*/
// TRADUCTION
function lang($texte){
         include ("../dyn/var.inc");
...
//
$pg_traduction=lang("palette_graphique");
$c_rvb_traduction=lang("composantes_rvb");
$rouge_traduction=lang("rouge");
$vert_traduction=lang("vert");
$bleu_traduction=lang("bleu");
$hexadecimal_traduction=lang("hexadecimal");
$couleur_traduction=lang("couleur");
$selection_traduction=lang("selectionnee");
$survol_traduction=lang("survolee");
$ok_traduction=lang("valider");
$annuler_traduction=lang("annuler");
$selection_traduction=lang("selection");
$fermer_traduction=lang("fermer");
$choix_traduction=lang("choisir");
$ddg_traduction=lang("degrade_de_gris");
$logo_traduction=lang("logo");
//
// parametrage =================================================================
$DEBUG=0;
// Recupération de champs
  ...
  if(isset($_GET['saturation']))
      ...
      $saturation="";
//
//<script type="text/javascript" src="rvb.js"></script>
?>
...
pal.ajouterPalette("graphique", "<?php echo $pg_traduction;?>", "24x16", "13x9");
pal.ajouterPalette("216", "216 <?php echo $couleur_traduction;?> HTML", "18x12", "17x11");
pal.ajouterPalette("256", "256 <?php echo $couleur_traduction;?>", "18x16", "13x11");
pal.ajouterPalette("gris", "<?php echo $ddg_traduction;?>", "18x12", "17x11");
    ...
    PaletteCouleurs.prototype.afficher = function() {
        ...
        if (this.erreur) this.afficherErreur();
            ...
            if (this.erreur) this.afficherErreur();
                ...
                var html = "<div id='palette'><br><font id='palette_titre'><?php echo $pg_traduction;?></font><br><br>";
                ...
                html += "<br><?php echo $logo_traduction;?><br><img src='../img/logorvb.png' style='border: 1px #000000 solid;'></div>";
                document.write(html);
            }
        }
    }
...
function InterfaceCouleurs() {
    ...
    InterfaceCouleurs.prototype.afficher = function(retour) {
        ...
        html += "<div><?php echo $c_rvb_traduction;?><br>&nbsp;<?php echo $rouge_traduction;?>&nbsp;<input type='text' id='rouge' name='rouge' size=" + largBoiteRVB + " value='' class='inputr'";
        html += " onchange='ui.RVBenCodeCouleur()' /></div>";
        html += "<div>&nbsp;<?php echo $vert_traduction;?>&nbsp;<input type='text' id='vert' name='vert' size=" + largBoiteRVB + " value='' class='inputv'";
        html += " onchange='ui.RVBenCodeCouleur()' /></div>";
        html += "<div>&nbsp;<?php echo $bleu_traduction;?>&nbsp;<input type='text' id='bleu' name='bleu' size=" + largBoiteRVB + " value='' class='inputb'";
        html += " onchange='ui.RVBenCodeCouleur()' /></div>";
        // la boîte indiquant le code couleur de la couleur sélectionnée
        html += "<div>&nbsp;<?php echo $hexadecimal_traduction;?>&nbsp;<input type='text' style='background-color:#ffffff;color:#A7A8B1' id='code_couleur' name='code_couleur' size=" + largBoiteCode + " value=''";
        ...
        html += "&nbsp;<?php echo $couleur_traduction;?>&nbsp;<?php echo $survol_traduction;?>&nbsp;<img src='" + g_url_img_vide + "' width='50' height='35' border='0' /></div>";
        // la case témoin de la couleur sélectionnée
        html += "<div id='temoin' style='background-color:#ffffff;color:#000000'>";
        html += "&nbsp;<?php echo $couleur_traduction;?>&nbsp;<?php echo $selection_traduction;?>&nbsp;<img src='" + g_url_img_vide + "' width='50' height='30' border='0' /></div>";
        // les 3 boutons "envoyer", "annuler" et "fermer"
        html += "<div class='boutons'><br><br><input type='submit' value='<?php echo $ok_traduction;?>'>";
        html += "<br><br><input type='reset' value='<?php echo $annuler_traduction;?>&nbsp;<?php echo $selection_traduction;?>' onclick='ui.annulerCouleur()' />";
        html += "<br><br><input type='button' value='<?php echo $fermer_traduction;?>' onclick='window.close()' /><br><br><?php echo $choix_traduction;?>&nbsp; <?php echo $pg_traduction;?></div>\n";
...
echo "\t</head>\n";
echo "\t<body id='palette_page'>\n";
?>
<script type="text/javascript">
<!-- Debut script
// affichage de la page    + $palette et $saturation
afficherPage('<?php echo $retour;?>','<?php echo $palette;?>','<?php echo $saturation;?>');
//  Fin script -->
</script>
<?php
echo "</body>";
