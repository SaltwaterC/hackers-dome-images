<?php
//$Id: upload.php,v 1.2 2008-07-17 09:44:15 jbastide Exp $
    ...
    if ($UploadError) {
        ...
        foreach($Upload-> GetSummary() as $elem){
           ...
           ?>
               ...
               parent.opener.document.f1.<?php echo $_GET['origine']?>.value='<?php echo $nom?>';
               parent.close();
               </script>
           <?php
        }
...
<form method="post" enctype="multipart/form-data" name="formulaire" id="formulaire" action="upload.php?origine=<?php echo $_GET['origine']?>" onsubmit="return valider()">
<?php
